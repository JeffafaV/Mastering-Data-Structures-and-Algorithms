...
// counts number of nodes in the linked list recursively
...
// sum of all the values in the nodes of the linked list
...
// sum of all the values in the nodes of the linked list recursively
